...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.port_select = QComboBox(self.frame_3)
        ...
        self.baud_rate_select = QSpinBox(self.frame_3)
        ...
        self.phy_select = QComboBox(self.frame_3)
        ...
        self.power_select = QComboBox(self.frame_3)
        ...
        self.channel_select = QSpinBox(self.frame_3)
        ...
        self.npackets_select = QSpinBox(self.frame_3)
        self.npackets_select.setObjectName(u"npackets_select")

        self.verticalLayout.addWidget(self.npackets_select)
